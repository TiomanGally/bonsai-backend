...
VALUES (gen_random_uuid(), 'Acer Buergerianum', 'von Gerald', '2015-01-01', 0.00, '2025-02-27'),
       (gen_random_uuid(), 'Acer Palmatum', null, '2021-03-07', 5.80, '2025-02-27'),
       ...
       (gen_random_uuid(), 'Ficus', 'First Bonsai', '2017-01-01', 0.00, '2024-03-02'),
       ...
       (gen_random_uuid(), 'Acer Palmatum Deshojo', 'Geplant für Othmar Auer Schale', '2021-03-07', 11.80,
        '2025-03-11'),
       (gen_random_uuid(), 'Crataegus monogyna', 'Weißdorn', '2021-03-07', 28.00, '2025-03-15'),
       (gen_random_uuid(), 'Acer Saccharinum', 'Silberahorn', '2024-02-15', 98.00, '2025-03-19'),
       ...
       (gen_random_uuid(), 'Larix Decidua', 'Klein', '2020-01-01', 5.80, '2025-03-15'),
       (gen_random_uuid(), 'Larix Decidua', 'Klein', '2020-01-01', 5.80, '2025-03-04'),
       (gen_random_uuid(), 'Acer Palmatum Orangeola', null, '2021-03-07', 40.80, '2025-03-19'),
       (gen_random_uuid(), 'Larix Decidua', 'Aus Esslingen', '2021-03-07', 0.00, '2024-06-02'),
       (gen_random_uuid(), 'Betula pendula', 'Birke aus Esslingen', '2021-03-07', 0.00, '2025-03-10'),
       ...
       (gen_random_uuid(), 'Ficus', 'Steckling', '2024-05-07', 0.00, '2025-03-16'),
       (gen_random_uuid(), 'Ficus', 'Steckling', '2024-05-07', 0.00, '2025-03-16');